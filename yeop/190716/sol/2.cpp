...
void matrix::operator+(matrix rhs){
	num[0][0] = rhs.num[0][0] + num[0][0];
	num[0][1] = rhs.num[0][1] + num[0][1];
	num[1][0] = rhs.num[1][0] + num[1][0];
	num[1][1] = rhs.num[1][1] + num[1][1];
}
void matrix::operator-(matrix rhs){
	num[0][0] = -rhs.num[0][0] + num[0][0];
	num[0][1] = -rhs.num[0][1] + num[0][1];
...
void matrix::operator*(matrix rhs){
	num[0][0] = num[0][0] * rhs.num[0][0] + num[0][1] * rhs.num[1][0];
	num[0][1] = num[0][0] * rhs.num[0][1] + num[0][1] * rhs.num[1][1];
	num[1][0] = num[1][0] * rhs.num[0][0] + num[1][1] * rhs.num[1][0];
	num[1][1] = num[1][0] * rhs.num[0][1] + num[1][1] * rhs.num[1][1];
}
...
matrix2 matrix2::operator+(matrix2 rhs){
	...
	matrix2 result("");
	result.num[0][0] = rhs.num[0][0] + num[0][0];
	result.num[0][1] = rhs.num[0][1] + num[0][1];
	result.num[1][0] = rhs.num[1][0] + num[1][0];
	result.num[1][1] = rhs.num[1][1] + num[1][1];
	return result;
}
matrix2 matrix2::operator-(matrix2 rhs){
...
matrix2 matrix2::operator*(matrix2 rhs) {
	...
	result.num[0][0] = num[0][0] * rhs.num[0][0] + num[0][1] * rhs.num[1][0];
	result.num[0][1] = num[0][0] * rhs.num[0][1] + num[0][1] * rhs.num[1][1];
	result.num[1][0] = num[1][0] * rhs.num[0][0] + num[1][1] * rhs.num[1][0];
	result.num[1][1] = num[1][0] * rhs.num[0][1] + num[1][1] * rhs.num[1][1];
